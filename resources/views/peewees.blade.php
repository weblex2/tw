            ...
            <div class="team-header-content-grid">
                <div>
                    ...
                    <div class="icon-wrapper">
                        ...
                        <span class="font-semibold"> 32 Peewees / 2 Teams</span>
                    </div>
                    <div class="icon-wrapper">
        ...
        <div class="whatwedo-wrapper">
            <div class="whatwedo">
                ...
                <div class="training-times">
                    ...
                    <i class="fa-regular fa-clock font-normal text-green-500"></i>&nbsp;<span class="day">Mittwoch</span><br>
                ...
                <div class="coachbox-wrapper">
                    <div class="coachbox">
                        ...
                        <br>
                        <h4>Lea, Jasmin, Lena-Marie, Isi & Leonie</h4>
                    </div>
                </div>
            </div>
        </div>
